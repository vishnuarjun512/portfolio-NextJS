...
const Projects = () => {
  ...
  return (
    <div
      id="projects"
      className="min-h-screen w-full flex flex-col items-center justify-start py-5"
    >
              ...
              <h1
                className={`${
                  category == uniqueCategories[index]
                    ...
                    : "hover:bg-green-200"
                } w-full md:px-[30px] lg:px-[50px] xl:px-[70px] p-2 py-3 md:py-5 text-[12px] sm:text-xl lg:text-3xl md:text-2xl text-center whitespace-nowrap font-semibold transition-all duration-200 ease-in-out bg-green-50 rounded-lg`}
                key={index}
                onClick={() => {
