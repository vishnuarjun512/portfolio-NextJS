...
const ProjectItem = ({ image, name, tech, hosted }) => {
  return (
    <div className="max-h-[200px] md:max-h-[500px] max-w-[90%] relative flex items-center justify-center group h-full w-full  shadow-gray-400 rounded-xl hover:bg-gradient-to-b hover:scale-105 from-gray-700 to-[#14131a] ease-in-out duration-700">
      <Image
